...
const App = () => {
    ...
    return (
        <>
            ...
            {`The motion of an object through space consists of two components: "translation" of the center of mass, and rotation around the center of mass.  The trajectory of the center of mass is either a straight line (in outer space), a parabola (near the surface of a gravitating body like the earth), or a conic section such as a circle, ellipse, or hyperbola (at a greater distance from a gravitating body).  This simulation considers the second type of motion: the free rotation of a body around its center of mass.  Except for the simple case of a body shaped as either a sphere or cube, this rotation is not as simple as one might think.  It is not like that of a globe which spins at a constant rate about its fixed axis.  Free rotation is governed by "Euler's torque-free equations", a system of three nonlinear differential equations which usually can only be solved numerically, as I do in this simulation. Each control/input below has a place where you can click`}
